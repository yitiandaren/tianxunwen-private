...
範例：
    python process_whatsapp_tianxunwen.py raw/whatsapp/20260728_whatsapp_tianxingwen.txt
"""
...
# ==================== 設定 ====================
SPEAKER_KEYWORDS = ["一天大人", "太素天尊"]  # 只要包含這些關鍵字就視為一天大人
SKIP_PATTERNS = [
    r"圖像已省略",
    r"影片已省略",
    r"貼圖已忽略",
...
def parse_whatsapp_line(line: str):
    """解析單行 WhatsApp 訊息"""
    # 格式範例：[2026/7/27 上午9:59:40] 一天大人 太素天尊-apple: 訊息內容
